<footer class="bg-gray-800 py-20 mt-20">
    <div class="sm:grid grid-cols-3 w-4/5 pb-10 m-auto border-b-2 border-gray-700">
        ...
        <div>
            ...
            <ul class="py-4 sm:text-s pt-4 text-gray-400">
                <li class="pb-1">
                    <a href="">Why Do we love Laravel</a>
                </li>
                <li class="pb-1">
                    <a href="">Which version you're on?</a>
                </li>
                <li class="pb-1">
                    <a href="">We love tech</a>
                </li>
                <li class="pb-1">
                    <a href="">How much do you code?</a>
                </li>
            </ul>
        </div>
    </div>
    <p class="w-25 w-4/5 pb-3 m-auto text-xs text-gray-100 pt-6">
        Copyrights 2018-2021 Lucien Versendaal, All Rights Reserved.
    </p>
</footer>
